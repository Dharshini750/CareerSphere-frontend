...
const NotificationsPage = () => {
	...
	const renderNotificationIcon = (type) => {
		switch (type) {
			case "like":
				return <ThumbsUp className='text-purple-700' />;
			case "comment":
				return <MessageSquare className='text-green-500' />;
			case "connectionAccepted":
				return <UserPlus className='text-purple-700' />;
			default:
				return null;
		}
	};
							...
							{notifications.data.map((notification) => (
								<li
									...
									className={`bg-white border rounded-lg p-4 my-4 transition-all hover:shadow-md ${
										!notification.read ? "border-purple-700" : "border-gray-200"
									}`}
								>
										...
										<div className='flex gap-2'>
											{!notification.read && (
												<button
													...
													className='p-1 bg-blue-100 text-purple-700 rounded hover:bg-blue-200 transition-colors'
